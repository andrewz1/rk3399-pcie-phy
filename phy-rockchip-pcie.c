...
static const struct of_device_id rockchip_pcie_phy_dt_ids[] = {
	{
// @andrewz1 changed id for replace builtin module, don't need for patch
		.compatible = "rockchip,rk3399-pcie-phy-new",
...
// @andrewz1 phy init function after warm boot
...
static int rockchip_pcie_phy_probe(struct platform_device *pdev)
{
	...
	rockchip_pcie_phy_reset(rk_phy); // @andrewz1
...
static struct platform_driver rockchip_pcie_driver = {
	...
	.driver		= {
// @andrewz1 changed module name for allow to load module with builtin one, don't need for patch
		.name	= "rockchip-pcie-phy-new",
